...
activities = {
    ...
    "Science Research Lab": {
        "description": "Conduct experiments and research in biology, chemistry, and physics",
...
def signup_for_activity(activity_name: str, email: str):
    ...
    if email in activity["participants"]:
        raise HTTPException(status_code=400, detail="Student is already signed up for this " \
        "activity")
